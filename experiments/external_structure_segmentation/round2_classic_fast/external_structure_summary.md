...
|---|---|---|---:|---:|---:|---:|---:|---:|
| 02_classic_msaf_like | manual_coarse | foote_checkerboard_loso_tuned | true | 0.494 | 0.497 | 0.495 | 159 | 160 |
| 02_classic_msaf_like | manual_coarse | agglomerative_loso_tuned | true | 0.354 | 0.465 | 0.402 | 159 | 209 |
| 02_classic_msaf_like | manual_fine | foote_checkerboard_loso_tuned | true | 0.468 | 0.508 | 0.487 | 244 | 265 |
| 02_classic_msaf_like | manual_fine | agglomerative_loso_tuned | true | 0.394 | 0.508 | 0.444 | 244 | 315 |

## Best Per Target

- `manual_fine` best new method: `foote_checkerboard_loso_tuned` (02_classic_msaf_like), F1=0.487.
- `manual_coarse` best new method: `foote_checkerboard_loso_tuned` (02_classic_msaf_like), F1=0.495.
